...
<?php
    ...
    $illustration_id = 'A4SQ69071300000859250018309584';

    $url = 'file://' . dirname( __FILE__ ) . DIRECTORY_SEPARATOR . 'canx_iid_antu_illustration-1.0.wsdl';
    //$endpoint_url = 'https://wwwdev.cannex.com/devext/CANX/AntyAnlyService';
    $endpoint_url = 'https://wwwdev.cannex.com/devext/CANX/IidAntuIllustrationService';
    ...
    $function_name = 'canx_iid_antu_illustration_operation';        // name of the function/request
    $arguments = array(
        'canx_iid_antu_illustration_operation' => array(
            ...
            'transaction_id' => '2d634ead-c642-4ec5-8649-' . uniqid(),
            'is_test' => 'Y',
            'version' => '1.0'
        )
    );
