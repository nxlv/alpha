                    ...
                    'child_tables' => [
                        ...
                        [
                            ...
                            'fields' => [
                                ...
                                'current_increase_fixed_rate' => [ 'type' => 'node', 'key' => 'current_increase_fixed_rate', 'data_type' => 'float' ],
                                'current_declared_rate' => [ 'type' => 'node', 'key' => 'current_declared_rate', 'data_type' => 'float' ],
                                'current_cap_rate' => [ 'type' => 'attribute', 'node' => 'current_cap_rate', 'key' => 'rate', 'data_type' => 'float' ],
                                'current_cap_rate_cd' => [ 'type' => 'attribute', 'node' => 'current_cap_rate', 'key' => 'cd' ],
                                'current_spread_rate' => [ 'type' => 'node', 'key' => 'current_spread_rate', 'data_type' => 'float' ],
                                'current_participation_rate' => [ 'type' => 'node', 'key' => 'current_participation_rate', 'data_type' => 'float' ],
                                'current_protection_buffer_rate' => [ 'type' => 'node', 'key' => 'current_protection_buffer_rate', 'data_type' => 'float' ],
                                'current_protection_floor_rate' => [ 'type' => 'node', 'key' => 'current_protection_floor_rate', 'data_type' => 'float' ],
                                'current_protection_downside_participation_rate' => [ 'type' => 'node', 'key' => 'current_protection_downside_participation_rate', 'data_type' => 'float' ],
                                'announced_fixed_rate' => [ 'type' => 'node', 'key' => 'announced_fixed_rate', 'data_type' => 'float' ],
                                'announced_declared_rate' => [ 'type' => 'node', 'key' => 'announced_declared_rate', 'data_type' => 'float' ],
                                'announced_cap_rate' => [ 'type' => 'attribute', 'node' => 'announced_cap_rate', 'key' => 'rate', 'data_type' => 'float' ],
                                'announced_cap_rate_cd' => [ 'type' => 'attribute', 'node' => 'announced_cap_rate', 'key' => 'cd' ],
                                'announced_spread_rate' => [ 'type' => 'node', 'key' => 'announced_spread_rate', 'data_type' => 'float' ],
                                'announced_participation_rate' => [ 'type' => 'node', 'key' => 'announced_participation_rate', 'data_type' => 'float' ],
                                'announced_protection_buffer_rate' => [ 'type' => 'node', 'key' => 'announced_protection_buffer_rate', 'data_type' => 'float' ],
                                'announced_protection_floor_rate' => [ 'type' => 'node', 'key' => 'announced_protection_floor_rate', 'data_type' => 'float' ],
                                'announced_protection_downside_participation_rate' => [ 'type' => 'node', 'key' => 'announced_protection_downside_participation_rate', 'data_type' => 'float' ],
                            ]
                        ]
                    ]
                ],
