...
return [
    /**
     *
     * Death Benefit Profiles
     * file: anty_ds_db_prfl-[x].[y].xml
     *
     */
    'data' => [
        'node' => 'death_benefit_profile',
        'filename' => 'anty_ds_db_prfl-1.1.xml',
        'table_name' => 'death_benefits',
        'child_tables' => [
            [
                'data' => [
                    'node' => 'info',
                    'table_name' => 'death_benefits_meta',
                    'element' => 'canx_info'
                ],
                'fields' => [
                    'death_benefit_profile_id' => [ 'type' => 'attribute', 'target' => '_root', 'key' => 'death_benefit_profile_id' ],
            ...
            [
                'data' => [
                    'node' => null,
                    'table_name' => 'death_benefits_product_associations',
            ...
            [
                'data' => [
                    'node' => 'state_cd_name',
                    'table_name' => 'death_benefits_states',
            ...
            [
                'data' => [
                    'node' => 'age_range',
                    'table_name' => 'death_benefits_issue_ages_owner',
            ...
            [
                'data' => [
                    'node' => 'age_range',
                    'table_name' => 'death_benefits_issue_ages_annuitant',
            ...
            [
                'data' => [
                    ...
                    'table_name' => 'death_benefits_current_rider_fees',
            ...
            [
                'data' => [
                    'node' => 'tier_rate_frequency',
                    'table_name' => 'death_benefits_min_rider_fees',
            ...
            [
                'data' => [
                    'node' => 'tier_rate_frequency',
                    'table_name' => 'death_benefits_max_rider_fees',
            ...
            [
                'data' => [
                    'node' => 'tier_rate_frequency',
                    'table_name' => 'death_benefits_step_ups',
            ...
            [
                'data' => [
                    'node' => 'tier_rate_frequency',
                    'table_name' => 'death_benefits_roll_ups',
            ...
            [
                'data' => [
                    'node' => 'premium',
                    'table_name' => 'death_benefits_initial_premiums',
            ...
            [
                'data' => [
                    'node' => 'premium',
                    'table_name' => 'death_benefits_max_premiums',
            ...
            [
                'data' => [
                    'node' => null,
                    'table_name' => 'death_benefits_premium_bonuses',
            ...
            [
                'data' => [
                    'node' => null,
                    'table_name' => 'death_benefits_premium_multipliers',
            ...
            [
                'data' => [
                    'node' => null,
                    'table_name' => 'death_benefits_persistency_credits',
            ...
            [
                'data' => [
                    'node' => null,
                    'table_name' => 'death_benefits_enhancements',
                    'element' => 'death_benefit_enhancement_instance'
                ],
                'fields' => [
                    'death_benefit_profile_id' => [ 'type' => 'attribute', 'target' => '_root', 'key' => 'death_benefit_profile_id' ],
                    'instance_id' => [ 'type' => 'attribute', 'target' => '_self', 'key' => 'instance_id' ],
                ...
                'data' => [
                    ...
                    'child_tables' => [
                        [
                            'data' => [
                                'node' => null,
                                'table_name' => 'death_benefits_interest_crediting',
                ...
                'data' => [
                    ...
                    'child_tables' => [
                        [
                            'data' => [
                                'node' => null,
                                'table_name' => 'death_benefits_interest_bonus_crediting',
                                'element' => 'tier_rate_frequency'
                            ],
                            'fields' => [
                                'death_benefit_profile_id' => [ 'type' => 'attribute', 'target' => '_root', 'key' => 'death_benefit_profile_id' ],
                ...
                'data' => [
                    ...
                    'child_tables' => [
                        [
                            'data' => [
                                'node' => null,
                                'table_name' => 'death_benefits_interest_multiplier_crediting',
                                'element' => 'tier_rate_frequency'
                            ],
                            'fields' => [
                                'death_benefit_profile_id' => [ 'type' => 'attribute', 'target' => '_root', 'key' => 'death_benefit_profile_id' ],
    ...
    'fields' => [
        ...
        'death_benefit_type' => [ 'type' => 'attribute', 'node' => 'death_benefit_type', 'key' => 'cd' ],
        'death_benefit_proprietary_type' => [ 'type' => 'attribute', 'node' => 'proprietary_death_benefit_type', 'key' => 'cd' ],
        ...
        'death_benefit_enhancement_text_id' => [ 'type' => 'attribute', 'node' => 'death_benefit_enhancement', 'key' => 'text_id' ],
    ]
];
