...
class CANNEXCacheGuaranteed extends Command {
     ...
     * @var string
     */
    protected $signature = 'cannex:cache-guaranteed';
            ...
            if ( !empty( $stack ) ) {
                        ...
                        foreach ( self::DEFAULT_DEFERRAL_INTERVALS as $interval ) {
                            $profile = [
                                'annuitant' => [
                                    ...
                                    'income_start_age_primary' => self::DEFAULT_PURCHASE_AGE + $interval
                                ],
                                'targets' => []
                            ];
                ...
                foreach ( $queue as $profile ) {
                    ...
                    foreach ( array_chunk( $profile[ 'targets' ], self::ANALYSIS_MAX_CHUNK_SIZE ) as $chunk ) {
                        foreach ( self::DEFAULT_MARITAL_STATUSES as $marital_status ) {
