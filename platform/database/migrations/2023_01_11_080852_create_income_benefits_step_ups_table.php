...
class CreateIncomeBenefitsStepUpsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('income_benefits_step_ups', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('income_benefits_step_ups');
    }
}
