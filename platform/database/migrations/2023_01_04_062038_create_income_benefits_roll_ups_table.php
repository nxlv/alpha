...
class CreateIncomeBenefitsRollUpsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('income_benefits_roll_ups', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('income_benefits_roll_ups');
    }
}
