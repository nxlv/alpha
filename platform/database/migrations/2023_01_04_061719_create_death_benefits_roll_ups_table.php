...
class CreateDeathBenefitsRollUpsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('death_benefits_roll_ups', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('death_benefits_roll_ups');
    }
}
