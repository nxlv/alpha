...
class CreateDeathBenefitsStepUpsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('death_benefits_step_ups', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('death_benefits_step_ups');
    }
}
