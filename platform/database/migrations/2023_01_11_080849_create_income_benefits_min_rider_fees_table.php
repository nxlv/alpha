...
class CreateIncomeBenefitsMinRiderFeesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('income_benefits_min_rider_fees', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('income_benefits_min_rider_fees');
    }
}
