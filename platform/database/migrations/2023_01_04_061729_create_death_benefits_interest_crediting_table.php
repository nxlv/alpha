...
class CreateDeathBenefitsInterestCreditingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('death_benefits_interest_crediting', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('death_benefits_interest_crediting');
    }
}
