...
class CreateDeathBenefitsMinRiderFeesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('death_benefits_min_rider_fees', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('death_benefits_min_rider_fees');
    }
}
