...
class CreateDeathBenefitsCurrentRiderFeesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('death_benefits_current_rider_fees', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('death_benefits_current_rider_fees');
    }
}
