...
class CreateIncomeBenefitsInterestCreditingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('income_benefits_interest_crediting', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('income_benefits_interest_crediting');
    }
}
