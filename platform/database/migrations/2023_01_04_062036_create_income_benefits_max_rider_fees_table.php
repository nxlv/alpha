...
class CreateIncomeBenefitsMaxRiderFeesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('income_benefits_max_rider_fees', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('income_benefits_max_rider_fees');
    }
}
